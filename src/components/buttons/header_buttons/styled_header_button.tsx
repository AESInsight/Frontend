...
const StyledHeaderButton: React.FC<StyledHeaderButtonProps> = ({
	...
	return (
		<button
			onClick={onClick}
			className={`text-white text-xs md:text-lg flex items-center gap-1 md:gap-2 py-1 md:py-2 rounded-md transition-transform duration-300 ease-in-out hover:scale-115 cursor-pointer ${className}`}
		>
